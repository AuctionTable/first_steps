    ...
    <>
      ...
      <div className="flex px-[1rem] py-[2rem] flex-col">
          ...
          <div className="w-full my-[1rem]">
              <h1 className="mx-auto px-[2rem] text-[2rem] sm:text-[3rem] font-extrabold text-text tracking-tight sm:tracking-normal leading-8 sm:leading-none text-center">Here Every <span className="text-accent">Bid</span> Tells a Story!</h1>
              <h2 className="mx-auto mt-[1rem] sm:mt-[2rem] px-[1rem] text-[1rem] sm:text-[1.5rem] text-text tracking-tight sm:tracking-normal leading-5 sm:leading-none text-center">Embark on an Adventure of Bidding, Bargains, and Unforgettable Finds!</h2>
          </div>
      ...
      <div className="w-full flex px-[2rem] py-[2rem] flex-col items-stretch text-text mt-[2rem]">
        ...
        <h1 className="text-[2rem] sm:text-[3rem] font-extrabold text-center">How it <span className="text-accent">Works</span>!</h1>
      ...
      {/* Feature Section Card Collection */}
        <div className="flex flex-col items-stretch justify-center gap-[1.5rem] my-[1.5rem]">
            ...
            <div className="flex flex-col items-center justify-center gap-[1rem] px-[1rem] sm:px-[2.25rem] py-[1.5rem] sm:py-[3rem] rounded-lg shadow-[0_3px_10px_rgb(0,0,0,0.2)]"> 
            ...
            <div className="flex items-center  justify-center gap-[1rem] px-[1rem] py-[1.5rem] rounded-lg shadow-[0_3px_10px_rgb(0,0,0,0.2)]"> 
              ...
              <div className="flex flex-col md:w-[60%] items-center justify-center gap-[1rem]">
                    ...
                    <div className="flex gap-[0.5rem]">
                            <Link className="rounded-md border-accent border-2 px-[0.5rem] sm:px-[1.5rem] py-[0.25rem] sm:py-[0.5rem] lg:py[1rem] text-[14px] lg:text-[1.5rem] font-semibold text-accent hover:bg-accent hover:text-primary" href={'/'}>Start Selling</Link>
                            <Link className="rounded-md border-accent border-2 px-[0.5rem] sm:px-[1.5rem] py-[0.25rem] sm:py-[0.5rem] lg:py[1rem] text-[14px] lg:text-[1.5rem] font-semibold text-primary bg-accent hover:bg-primary hover:text-accent" href={'/'}>Start Bidding</Link>
                    </div>
              </div>
